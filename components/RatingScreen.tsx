      ...
      <div className="w-full max-w-lg mx-auto bg-[var(--color-bg-secondary)] p-8 rounded-2xl shadow-2xl border border-[var(--color-border-primary)]">
        ...
        {isReviewForFreebieEnabled && reviewFreebieTakesCount > 0 && (
          <div className="text-center bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg mb-6">
            <p className="font-bold text-[var(--color-text-accent)]">{ratingScreenFreebieTitle}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="userName" className="block text-sm font-bold mb-2 text-[var(--color-text-secondary)]">{ratingScreenNameLabel}</label>
            <input
              id="userName"
              type="text"
              value={userName}
          ...
          <div>
            <label className="block text-sm font-bold mb-2 text-center text-[var(--color-text-secondary)]">{ratingScreenRatingLabel}</label>
          ...
          <div>
            <label htmlFor="description" className="block text-sm font-bold mb-2 text-[var(--color-text-secondary)]">{ratingScreenCommentLabel}</label>
            <textarea
              id="description"
              value={description}
